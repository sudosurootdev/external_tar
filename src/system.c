  ...
  if (child == 0)
    {
      ...
      //exec_fatal (shell); kalen.lee@lge.com comment it out,as it is not defined. 
    }
  else
    {
      int wait_status;
...
sys_child_open_for_compress (void)
{
  ...
  if (!_remdev (archive_name_array[0])
      ...
      if (strcmp (archive_name_array[0], "-"))
	{
      ...
      //exec_fatal (use_compress_program_option); kalen.lee@lge.com comment it out as it is not defined. 
    }
...
sys_child_open_for_uncompress (void)
{
  ...
  if (strcmp (archive_name_array[0], "-") != 0
	...
	open_fatal (archive_name_array[0]);
      ...
      execlp (use_compress_program_option, use_compress_program_option,
	      "-d", (char *) 0);
      //exec_fatal (use_compress_program_option); kalen.lee@lge.com comment out it as it is not defined.  
    }
...
sys_exec_command (char *file_name, int typechar, struct tar_stat_info *st)
{
  ...
  //exec_fatal (file_name); kalen.lee@lge.com comment out it as it is not defined.
  return -1;  /* kalen.lee@lge.com add it due to compile error */
}
...
sys_exec_info_script (const char **archive_name, int volume_number)
{
  ...
  //exec_fatal (info_script_option); kalen.lee@lge.com comment it out, as it is not defined.  
  return -1; /* kalen.lee@lge.com add it due to compile error */
}
